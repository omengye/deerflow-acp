...
class RequestAdmissionConfig(BaseModel):
    """Optional process-local pacing shared by a model or quota group."""
...
class ModelConfig(BaseModel):
    ...
    request_admission: RequestAdmissionConfig | None = Field(
        default=None,
        description="Opt-in process-local RPM pacing for this model or quota group",
    )
